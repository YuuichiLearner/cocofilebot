...
# Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6667689198:AAGljkKbsJh3un6bsFS9qr1NcI5yUzhJ6vE")
...
try:
    ADMINS=[5090651635]
    for x in (os.environ.get("ADMINS", "6159157391 1733067205 5911422304 2067141797 1163318744 5734659617").split()):
        ADMINS.append(int(x))
except ValueError:
